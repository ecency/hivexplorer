...
import { getMarketData } from '../../api/urls';
import './market.scss'
...
class Market extends BaseComponent<Props, State> {
    ...
    render() {
        ...
        if (prices.length) {
          ...
          const config:any  = {
            ...
            chart:{
                height: 140,
                zoomType: 'x',
                backgroundColor: theme === Theme.night ? "#161d26" : "#f5f5f5"
            },
            plotOptions:{
                area:{
        ...
        return <div className={theme==="day"?"market-graph market-graph-day":"market-graph market-graph-night"} ref={this.node}>
            <div className="graph">
