                            ...
                            {Object.keys(user).map((k,index)=>{
                              return(
                               typeof(user[k])!=='object' && typeof(user[k])!=='boolean'? 
                                <StringField changeUser={changeUser} key={index+k+'string'} item={k} number={index} value={user[k]} label_for='user-info' />
                                :
                                typeof(user[k])==='boolean'? 
                                <StringField  key={index} item={k} number={k+'boolean'+index} value={JSON.stringify(user[k])} label_for='user-info' />
                                :
                                typeof(user[k])==='object'?
                                <ObjectField changeUser={changeUser} key={index+k} item={k} number={index} value={user[k]} label_for='user-info'/>
                                :
                                <></>
                              )})}
                            </TabPanel>
